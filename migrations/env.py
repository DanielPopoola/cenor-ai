...
# Domain models must be imported here (even if unused directly) so
...
from feedback.models import FeedbackORM  # noqa: F401
...
# Single source of truth for the DB URL is Settings, not alembic.ini —
# overriding here means alembic.ini's sqlalchemy.url line is never
# read, avoiding two disconnected places to update the same value.
