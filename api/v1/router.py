...
from feedback.routes import session_feedback_router, feedback_history_router
...
api_router.include_router(
    session_feedback_router, prefix="/sessions", tags=["feedback"]
)
api_router.include_router(
    feedback_history_router, prefix="/feedback", tags=["feedback"]
)
